...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { available: @slot.available, day: @slot.day, end: @slot.end, start: @slot.start, user_id: @slot.user_id } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { available: @slot.available, day: @slot.day, end: @slot.end, start: @slot.start, user_id: @slot.user_id } }
